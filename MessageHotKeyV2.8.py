...
entry = tk.Entry(root, bg='black', fg='green')
entry.pack()

# Checkbox to enable repeat message sending
repeat_send_var = tk.BooleanVar()
repeat_send_checkbox = tk.Checkbutton(root, text="Repeat Send Message", variable=repeat_send_var, bg='black', fg='green')
repeat_send_checkbox.pack()

# Entry for the number of times to repeat sending message
repeat_count_var = tk.IntVar()
repeat_count_label = tk.Label(root, text="Repeat Count:", bg='black', fg='green')
repeat_count_label.pack()

repeat_count_entry = tk.Entry(root, textvariable=repeat_count_var, bg='black', fg='green')
repeat_count_entry.pack()

# Button to set the hotkey
hotkey_button = tk.Button(root, text="Set Hotkey", command=set_hotkey, bg='black', fg='green')
hotkey_button.pack()

# Label to display the current hotkey
hotkey_label = tk.Label(root, text="Hotkey: not set", bg='black', fg='green')
hotkey_label.pack()
